...
function Navbar() {
  ...
  return (
    <>
      ...
      <header id="navFlex" className="ease-in duration-75 sm:p-1 sm:m-1 h-0 sm:h-auto overflow-hidden opacity-0 sm:opacity-100 fixed sm:static bottom-0 left-0 flex sm:flex-row flex-col items-center justify-between z-50">
